...
// 5.12.2026
/*
Code below has been modified for Question 1 for Chapter 28 of Crafting Interpreters.

Implements a faster class initialization method lookup by caching the init method
directly in the ObjClass structure for O(1) access instead of a hash table lookup.
*/
#include <stdarg.h>
#include <stdio.h>
#include <string.h>
        ...
        switch (OBJ_TYPE(callee)) {
            case OBJ_BOUND_METHOD: {
                ...
                case OBJ_CLASS: {
                    ...
                    // Fallback to table lookup if cache is NULL                    Value initializer;
