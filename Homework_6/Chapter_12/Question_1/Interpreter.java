...
Adds runtime construction of metaclasses and class methods so static method
calls like Math.square(3) are resolved and executed correctly.
*/
...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        LoxClass metaclass = new LoxClass(stmt.name.lexeme + " metaclass",
                null, classMethods);
