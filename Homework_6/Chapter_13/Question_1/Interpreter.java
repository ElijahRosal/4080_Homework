...
Adds runtime evaluation of mixin declarations and wires included mixin objects
through class construction so method lookup searches mixins between class and superclass.
*/
...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        for (Expr.Variable mixinExpr : stmt.mixins) {
            ...
            if (!(value instanceof LoxMixin)) {
                throw new RuntimeError(mixinExpr.name,
                        "Can only include mixins in 'with' clause.");
            }
            mixins.add((LoxMixin) value);
        }
        environment.define(stmt.name.lexeme, null);
        if (stmt.superclass != null) {
        ...
        LoxClass klass = new LoxClass(stmt.name.lexeme, (LoxClass)superclass, mixins, methods);
        if (superclass != null) {
