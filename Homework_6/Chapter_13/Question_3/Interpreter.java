...
Adds a native dict() constructor and dictionary property access so Lox has a
built-in key/value data structure for practical programs.
*/
...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    Interpreter() {
        ...
        globals.define("dict", new LoxCallable() {
            @Override
            public int arity() { return 0; }
            ...
            public Object call(Interpreter interpreter,
                               List<Object> arguments) {
                return new LoxDictionary();
            }

            @Override
            public String toString() { return "<native fn dict>"; }
        });
    }
    @Override
    ...
    public Object visitGetExpr(Expr.Get expr) {
        ...
        if (object instanceof LoxDictionary) {
            return ((LoxDictionary) object).get(expr.name);
        }
        throw new RuntimeError(expr.name,
