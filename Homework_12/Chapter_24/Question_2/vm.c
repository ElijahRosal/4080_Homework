...
Adds arity checking to native functions. Native functions now validate that
calls pass the correct number of arguments, preventing crashes from uninitialized
memory access and providing clear error messages to users.
*/
