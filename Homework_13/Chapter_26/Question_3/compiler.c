...
Retains compiler-owned function name strings and releases the compiled function
if compilation fails under the reference-counted runtime.
*/
...
static void initCompiler(Compiler* compiler, FunctionType type) {
    ...
    if (type != TYPE_SCRIPT) {
       ...
       parser.previous.length);
        retainObject((Obj*)current->function->name);
    }
